...
<script src="${ctx}/static/assets/js/fuelux/fuelux.wizard.js"></script>
<script src="${ctx}/static/assets/js/jquery.validate.js"></script>
<script src="${ctx}/static/assets/js/additional-methods.js"></script>
